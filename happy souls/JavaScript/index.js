...
var carts = document.querySelectorAll('.bucket-hats');
...
for (let i=0; i< carts.length; i++){
    ...
    var bucketIMG = document.querySelectorAll('.bucket-hats')[i].getAttribute("src"); 
    var price= document.querySelectorAll('.bucket-hats')[i].getAttribute("alt");
    var decription= document.querySelectorAll('.bucket-hats')[i].getAttribute("id");
